        ...
        for (let ad of data) {
            ...
            function print() {
                ...
                if (status) {
                    text += '<tr>'
                    text += '<td class="p-1">'
                    text += '<button class="btn btn-secondary mt-5" type="submit" disabled>В архиве</button>'
                    text += '</td>'
                    text += '</tr>'
                } else {
                    text += '<tr>'
                    text += '<td class="p-1">'
                    text += '<a href="/add.do?id=' + addId + '">'
                    text += '<button class="btn btn-info mt-5" type="submit">Редактировать</button>'
                    text += '</form>'
                    text += '</td>'

                    text += '<td class="p-1">'
                    text += '<form action="/private.do?action=remove&id=' + addId + '" method="post">'
